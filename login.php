...
<head>
  ...
  <title>Login | PT SEMESTA TRANSPORTASI LIMBAH INDONESIA</title>
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h3>
          <img class="" src="<?= base_url() ?>/assets/dist/img/logo.png" style="margin-top: 20px; margin-bottom: 20px;" width="300px;" height="90px;">

      </div>
      <div class="card-body login-card-body" style="background-color: #4040D9;">
        ...
        <form action="" method="POST">
          ...
          <button type="submit" name="login" class="btn btn-default btn-block bg-gradient-white btn-xm"><i class="fa fa-home mr-1"></i>Masuk</button>
          <br>
        </form>
