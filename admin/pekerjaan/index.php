                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                            $no = 1;
                                            $data = $koneksi->query("SELECT * FROM pekerjaan AS p
                                            ...
                                            ?>
                                                <tbody style="background-color: white">
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_pekerjaan'] ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                                            <a href="hapus?id=<?= $row['id_pekerjaan'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            <?php } ?>
