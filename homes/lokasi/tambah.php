...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('admin/lokasi/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("INSERT INTO lokasi  VALUES (
            NULL,
            '$nama_lokasi'
            )");
