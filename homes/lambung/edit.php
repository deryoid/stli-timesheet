...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM lambung WHERE id_lambung = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Ubah lambung</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama_lambung" value="<?= $row['nama_lambung']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE lambung SET  
                            nama_lambung = '$nama_lambung'
                            WHERE 
                            id_lambung = '$id'");
